...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_20.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_21.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_22.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_23.png
    :align: center

Check "Create desktop icon" and then it will generate a shortcut on your desktop to facilitate you to open Thonny later.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_24.png
    :align: center

Click "install" to install the software.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_25.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_26.png
    :align: center

Once you see the interface as below, Thonny has been installed successfully.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_27.png
    :align: center

If you've check "Create desktop icon" during the installation process, you can see the below icon on your desktop.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_28.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_29.png
    :align: center

Select "View" -> "Files" and "Shell".

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_30.png
    :align: center

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_31.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_32.png
    :align: center

2. In the new interface, find the following content and download the corresponding UF2 according to your Pico version

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_33.png
    :align: center
...
.. note::
    ...
    :red:`Pico and Pico W burn firmware in the same way. Pico's map is used here as an introduction.`
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_37.png
    :align: center

2.	Select "Micropython (Raspberry Pi Pico)".

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_38.png
    :align: center

3.	Select "USB-SERIAL (COMx)", The number x of COMx may varifies among different computers. You only need to make sure selecting USB-SERIAL (COMx). 
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_39.png
    :align: center

Step 2: Close the dialog box. Connect Pico to your computer, click "Run" again and select "Select interpreter". Click "Port" on the pop-up window and check the current ports. Now there is a newly added port, with which Pico commucates with the computer.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_40.png
    :align: center

4. After selecting "Micropython (Raspberry Pi Pico)" and port, click "OK" 

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_41.png
    :align: center

5. When the following message displays on Thonny, it indicates Thonny has successfully connected to Pico.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_42.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_43.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_44.png
    :align: center

2.	On the newly pop-up window, click "This computer".

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_45.png
    :align: center
...
:red:`Freenove_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico/00.0_HelloWorld` folder. 

Click "Run current script" to execute the program and "Hello World!", "Welcome Freenove" will be printed in "Shell".

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_46.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_47.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_48.png
    :align: center

1.	Click "File" -> "New" to create and write codes.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_49.png
    :align: center
...
.. note::
    ...
    If your board is Pico, please use 25 to drive the on-board LED. If your board is Pico W, use "LED" to drive the on-board LED. Pico is used as an example to explain.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_50.png
    :align: center

3.	Click "Save" on the menu bar. You can save the codes either to your computer or to Raspberry Pi Pico.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_51.png
    :align: center

4.	Select "MicroPython device", enter "main.py" in the newly pop-up window and click "OK".

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_52.png
    :align: center

5.	You can see that codes have been uploaded to Raspberry Pi Pico.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_53.png
    :align: center

6.	Disconnect Raspberry Pi Pico USB cable and then reconnect it, the LED on Raspberry Pi Pico will blink repeatedly.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_54.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_55.png
    :align: center

If it doesn't work, please click on "stop/restart backend" for more times or reconnect Pico. 

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_56.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_57.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_58.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_59.png
    :align: center

Upload main.py in the same way.

.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_60.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_61.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_62.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_63.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_64.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_65.png
    :align: center
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_72.png
    :align: center
...
.. note::
    ...
    The functional pin sequence of Pico and Pico W is the same. Therefore, even if your kit is Pico W, it is also applicable to the sticker above.
...
.. image:: ../_static/imgs/0_Getting_Ready_(Important)/Chapter00_73.png
    :align: center